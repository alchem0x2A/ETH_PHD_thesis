...
%
A precise determination of the interfacial tension of even
...
the area of the 2D material,  \(\psi_{\mathrm{2D}}\) and \(q\) are the
...
airborne contamination do not influence \((\Delta
...
material (\autoref{fig:wet-dcos-all-2D}\lc{a}).  As addressed earlier, since \((\Delta \cos \theta)^{\mathrm{Orien}}\) of
