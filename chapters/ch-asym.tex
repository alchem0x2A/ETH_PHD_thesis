...
\begin{figure}[!htbp]
  ...
  \caption{\label{fig:asym-ml-eta} \worktodo{more}}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{\label{fig:asym-first-principles1} \worktodo{more}}
\end{figure}
...
the maximum quantum capacitance reaching $\sim{}$30-33 \worktodo{unit?}in 3L G/3L
MoS\textsubscript{2} system, under an electric field of -1
V/nm.

\begin{figure}[!htbp]
  \import{\imgdir}{qc-compare.pdf_tex}
  \caption{\label{fig:asym-qc} \worktodo{add}}
\end{figure}
%
...
\worktodo{change the symbol of δ and μ}
\worktodo{check 1st appearance of CNp}
