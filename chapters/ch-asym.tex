...
\chapterabstract{Part of this chapter appears in the following journal
  ...
  heterostructures. Nat Commun. 9, 1271 (2018).  }
...
\begin{figure}[!htbp]
  \centering{}
  \import{\imgdir}{mqcm_results.pgf}
...
(~\autoref{fig:asym-mqcm-result}\lc{d} top) and $\E_{\mathrm{ext}}=+2$
V·nm$^{-1}$ (~\autoref{fig:asym-mqcm-result}\lc{d} bottom),
respectively.
%
