...
\begin{figure}[!htbp] %
    \centering{}
  \import{\imgdir}{first_principles.pgf}
...
a semiconductor-graphene (SG) junction.  }
...
values applied is shown in \autoref{fig:qc-chara-bias-res}\lc{a}.
%
Compared with
...
$\sigma\subs{M}$, as shown in \autoref{fig:qc-chara-bias-res}\lc{b}.
%
\begin{figure}[!htbp]
  \centering %
  \import{\imgdir}{bias-effect-res.pgf}
  \caption{ The effect of $V\subs{b}$ in a MOGS QC. \textbf{a}. Calculated $\psi_0$ as a
function of $V\subs{b}$, under different $\sigma\subs{M}$ values. The
arrow indicates the direction of increasing $\sigma\subs{M}$.  \textbf{b}.
