...
% $\sigma_{ G,Si}=\sigma ()$  Blue and red isosurfaces represent positive and negative charge. $\sigma_{Si}(10^{13}$ cm$^{-2})$) = \sim 0.98$.
...
using the  {\ttfamily SIESTA} method\cite{soler02}  and the {\ttfamily VASP} code\cite{kresse93,kresse96}. 
...
have been used. A double-$\zeta$ polarized basis set in {\ttfamily SIESTA}, and a well-converged plane-wave 
cutoff of 400 eV in {\ttfamily VASP} were utilized in the calculations. Projected augmented wave 
...
as implemented in the {\ttfamily SIESTA}\cite{soler02} code was used. We have utilized an 
