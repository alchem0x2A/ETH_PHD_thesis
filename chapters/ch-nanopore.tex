...
% wafer-scale graphene samples \autocite{Choi_2018_wafer_scale_gr}.
...
The experimental setup presented here allows us to systematically
...
$V_{\mathrm{G}}$ within $\pm{}1.25$ V, before triggering the
...
\autocite{Nam_2009_IFET_sub10nm,Cheng_2018_gate_gox}. A further increase of the KCl
...
\autoref{fig:np-simple-rect-pore}a shows the contribution $w$ and $\xi$ as
...
\end{figure}
%
\autoref{fig:np-6}a presents the measured salt rejection $\xi$ as a
function of $V_{\mathrm{G}}$ at $c_{0}$ = 0.1 mM, for the seven salt
species considered here, including NaCl, LiCl, KCl, MgSO$_{4}$,
CaCl$_{2}$, K$_{2}$SO$_{4}$, and K$_{3}$[Fe(CN)$_{6}$].
%
%
...
ions~\autocite{vanysek_2000_CRC_diffusivity}.
%
The calculated and
