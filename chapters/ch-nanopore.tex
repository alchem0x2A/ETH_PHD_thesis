...
diffusive flux values, $\symbfol{J}_{\mathrm{PG0}}$, remain at the
...
\begin{equation}
  ...
  \eta = \frac{\bar{s} - s_{2}}{\bar{s}} = \frac{\symbfol{J}_{\mathrm{PG0}}
    - \symbfol{J}_{\mathrm{PG}}(V_{\mathrm{G}})}{\symbfol{J}_{\mathrm{PG0}}}
\end{equation}
where $\bar{s}$ is the average slope of $s_{1}$ and $s_{3}$, namely
$(s_{1} + s_{3})/2$, and
$\symbfol{J}_{\mathrm{PG}}(V_{\mathrm{G}})$ is the diffusive flux
...
\end{equation}
where $\symbfol{J}$ is the mass flux, subscript \textit{i}
...
$\symbfol{J}_{z}$ ,as a function of the normalized radius,
$r/r_{\mathrm{G}}$ , where $r$ is the radial coordinate and
$r_{\mathrm{G}}$ is the pore radius, at different $V_{\mathrm{G}}$
values. Note that $\symbfol{J}_{z}$ is negative because the LCR is
...
pore, $|\symbfol{J}_{z}|$, are reduced with $V_{\mathrm{G}}$
...
\begin{figure}[H]
  ...
  \caption{ \textbf{The experimental evidence of salt rejection.}
    ...
    bars: experimental, $\symbfol{J}_{\mathrm{PCTE}}$ Exp.; red
    bars: model values, $\symbfol{J}_{\mathrm{PCTE}}$
    ( \autoref{eq:np-j-pcte})) and PG+PCTE
    ($\symbfol{J}_{\mathrm{PG0}}$ Exp.; green bars) membranes for
    different salts. \textcolor{blue}{The error bars for
      $\symbfol{J}_{\mathrm{PCTE}}$ Exp. were estimated by the
      standard deviation of three consecutive measurements. The error bars
      for $\symbfol{J}_{\mathrm{PCTE}}$ ( \autoref{eq:np-j-pcte})
      ...
      bars for $\symbfol{J}_{\mathrm{PG0}}$ Exp. were estimated by
...
\begin{figure}[H]
  ...
  \caption{\textbf{Calculations using the proposed self-consistent
    ...
    diffusive fluxes $\symbfol{J}_{z}$ for cation (left) and anion
