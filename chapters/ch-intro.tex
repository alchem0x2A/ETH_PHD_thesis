...
The concept of 2D materials interfaces can be
...
the π-π interaction ~\autocite{Grimme_2008_pipi,Zhang_2011_rev_pipi_gr}, a
phenomenon widely known as the graphene template effect
~\autocite{Yang_2015_rev_template}. MPc molecules (e.g. M=Cu, Fe, Co and
...
or glass
~\autocite{Ying_Mao_2011_ge_clAlPc,Zhang_2011_FePc_gr,Hamalainen_2012_CoPc_gr_Ir,,Xiao_2013_jacs_CuPc_gr}.
Similarly, the graphene template effect is also found  for PEN
~\autocite{Zhou_2013_penta_gr_Ru,Lee_2011_pentacene,Lee_2011_pentacene,Zhang_2015_gr_pent_orient},
C\(_{\text{60}}\) ~\autocite{Kim_2015_c60_gr,Shih_2015_PartiallyScreened},
p-sexiphenyl (6P) ~\autocite{Hlawacek_2011_6P_gr}, and
dibenzotetrathienocoronene (DBTTC) ~\autocite{Kim_2016_DBTTC_gr} molecules,
...
``face on'' configuration ~\autocite{Matkovic_2016_6P_hBN} similar to the
case on graphene. However, non-planar molecules such as rubrene
~\autocite{Lee_2014_rubene_hBN} adopt the ``edge-on'' configuration over the ``face-on'' configuration, reflecting the fact
...
graphene due to its large dipole moment ~\autocite{Rajan_2016_wett_mos2},
and is highly dependent on the lattice symmetry
~\autocite{Shen_2017_DFT_mos2_pent} (i.e. 1T- or 2H- phase) and surface
defects ~\autocite{Jariwala_2016_Mos2_pentacene,
...
% ~\autocite{Chen_2013_doping,Sorensen_2014,Le_2012_MoS2_Cu}, TMDC/TMDC
% ~\autocite{Kang_2013_TMDC_moire,Zhang_2014_vdw_epi_SnS2_MoS2,Diaz_2015_MoTe2_MoSe2,Fang_2014_intercoupl_vdW,Li_2016_GaSe_MoSe2_vdW},
% and TMDC/hBN ~\autocite{Fang_2014_intercoupl_vdW} surfaces. Following the
...
% coupled layers, e.g. TMDC/Ru(0001) ~\autocite{Chen_2013_doping} and TMDC/TMDC
% ~\autocite{Fang_2014_intercoupl_vdW} heterostructures may also lead to the
% site-specific adsorption phenomenon ~\autocite{Diaz_2015_MoTe2_MoSe2}, in
...
One of the major differences between the interfacial molecules on 2D
...
\autocite{Nguyen_2019_PEN} (\autoref{fig:intro-mol-sub}\lc{a}).
%
...
%
In organic molecular deposition (~\autoref{fig:intro-0D-2D}\lc{a}),
...
The 2D vdW heterostructures (vdWHs) are formed by
...
crystal devices~\autocite{Lee_2014_rubene_hBN} (~\autoref{fig:intro-3D-2D}\lc{c}).
%
...
\autoref{ch:np} aims to understand the ionic transport through
