...
are good example of such material design are, which are
covalently-bonded crystalline films with only one- or few-atom
thickness.
%
Starting from the first discovering of
...
industries~\cite{Xia_2014,Bhimanapati_2015_2D_rev}.
%
...
forces~\citetitle{Israelachvili_2011_book}.
%
...
\begin{figure}[htbp]
  ...
  \caption{\label{fig:intro-papers} %
    ...
    Google scholar with interval of 1 year. }
\end{figure}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{1.00\textwidth}{XXXX}
    ...
    Graphane & C\textsubscript{2}H\textsubscript{2} &  P$\overline{3}$m1 & Graphane, Fluorographene\\
...
\end{tabularx}
\end{table}
\worktodo{check if symmetry correct}
...
plane form delocalized π-electron cloud. \worktodo{cite}
%
