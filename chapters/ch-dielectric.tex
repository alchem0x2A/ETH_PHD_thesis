...
optical absorption\cite{Kittel_2005_introduction_book} and 
...
theoretical \cite{Adler_1962_eps,Hybertsen_1987} and experimental techniques \cite{Palik_1998_handbook} of distinct flavors
...
$\varepsilon$ can be more than one order of magnitude. As a
...
\AA{} into the vacuum ( \autoref{fig-1}{\textbf a} and Supplementary
...
alike results (see Supplementary  \autoref{SI-fig:GW-PBE-alpha}).
...
Section \autoref{SI-ssec:gw}). Despite various levels of theory involved,
...
Supplementary ~\autoref{SI-fig:rho-profile}.
%
%
...
respectively (details see Supplementary Section \autoref{SI-ssec:gw}).
%
% 
% 
% 
...
Supplementary ~\autoref{SI-fig:rescale-prb}). The fitted values of
...
Supplementary Section \autoref{SI-sec:theory-1} for details):
% \begin{subequations}
% \begin{eqnarray}
...
Supplementary Section \autoref{SI-sec:pol-2D-Eg}).  We then examine
...
Section \autoref{SI-sec:pol-2D-Eg} and Supplementary 
...
in Supplementary Section~\autoref{SI-sec:gpaw}.
...
\autoref{SI-ssec:theory-1-perp-fundamental} shows an explanation of this
...
(Supplementary Section \autoref{SI-sec:gpaw-3}).
...
Supplementary Section \autoref{SI-sec:aniso}), which is the basis for the
...
dimensions (details see Supplementary Section \autoref{SI-sec:aniso}) on
