...
\autoref{fig:diel-universal}\lc{b} shows
$(4 \pi \varepsilon_{0})/\alpha_{\mathrm{2D}}^{\parallel}$ (in
...
\ref{fig:diel-universal}\lc{c}. We can see that such simple model
...
\autoref{fig:diel-universal}\lc{b} and
...
\end{figure}
%
 \autoref{fig:diel-NL}\lc{a} and \autoref{fig-4}\lc{b} show
...
The polarizability ellipsoid picture
...
transparency phenomena \worktodo{cite previous sections
}\cite{Li_2014_screen} and the large exciton binding energies
