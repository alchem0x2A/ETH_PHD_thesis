...
%
The monotonic behavior of $I(\Gamma, \infty)$ with $\Gamma$ is
...
\begin{enumerate}
\item The {\bfseries frequency-dependent vdW transparency} index $\tau(i\xi)$,
...
\item The {\bfseries overall vdW transparency} index $\eta$, defined as
